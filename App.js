...
function Logout() {
  const { logout, setUserIsAuthenticated, updateUser, currentUser, getToken } = useAuth();
  ...
  return (
    <View style={styles.view}>
      <Text style={styles.caption}>You are logged in as {currentUser ? currentUser.name : ''}</Text>
